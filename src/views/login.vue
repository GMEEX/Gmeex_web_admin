...
-->
		...
		<!--<div style="position:absolute;top: 10px;font-size: 14px;margin-top: 10px;margin-left: 30px;color:rgb(255 238 211);text-shadow: 1px 0px 2px #000;width: 400px;text-align: left;border-radius: 5px;padding: 5px 0;">购买商用稳定版请添加QQ：877070886</div>-->
	</div>
</template>
